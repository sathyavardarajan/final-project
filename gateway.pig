gate_data =  LOAD  '/home/hduser/gateway'  USING PigStorage('\t')  AS  (gateway:chararray, suc:int);
--dump gate_data;
web_data =  LOAD  '/home/hduser/weblog'  USING PigStorage('\t')  AS  (name:chararray, gateway:chararray, time);
--dump gate_data;
